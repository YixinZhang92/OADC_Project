...
global Strike Dip Strike_old Dip_old Nt_old con_tol
...
[xbt,ybt,zbt,xvt,yvt,zvt,vec_plane_t,Ltn,Wtn] = randfaults_local(xst,yst,zst,Lt,Wt,con_tol,2);
%[xbt,ybt,zbt,xvt,yvt,zvt,vec_plane_t,Ltn,Wtn] = kmeans_fault_local(xst,yst,zst,2);
...
for k=1:2 
        ...
        % eigenvector that describes each plane
        vec_plane_old(kg,1:3)=vec_plane_t(k,:);
