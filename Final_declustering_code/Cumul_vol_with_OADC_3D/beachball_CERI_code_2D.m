...
beachball_CERI_code([0 45 90; 0 50 0; 0 30 30],[0 5 -5],[0 5 -5],[1 1 1],0,'k');
...
function beachball_CERI_code(fm, centerX, centerY, diam, ta, color)
%function bb(fm, centerX, centerY, diam, ta, color)
%
% To run, 
% clear all; close all ;clc;
% 
% beachball_CERI_code([0 45 45],0,0,1,0,'k');
% xlim([-5 5]);
% ylim([-5 5]);
% axis equal
%
