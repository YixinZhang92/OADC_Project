function [JFINAL]=faultcluster_local(xvt,yvt,zvt,xbt,ybt,zbt,vec_plane_t,Ltn,Wtn,con_tol,n0)
...
while (DJ > con_tol) && (kj < max_iter)
    ...
    %  global variance J
    J=pcluster_local(xst,yst,zst,xvt,yvt,zvt,xbt,ybt,zbt,vec_plane_t,Ltn,Wtn,n0);
