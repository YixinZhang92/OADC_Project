function pfocsphere(nmech,mom,stype,vp,vs,dens,p_pol,nodeflag,axflag,dataflag, z_displ)
%
%   function pfocsphere(m,stype,vp,vs,dens,p_pol,nodeflag,axflag,dataflag)
%
%   Plot the lower hemisphere equal area projection of the P wave
%   focal sphere.
%
...
%hpfoc=figure('color','w','name','P Wave Nodal Surfaces');
hold on;
%set(gca,'color','w');
daspect([1 1 1]);
%axis off;
