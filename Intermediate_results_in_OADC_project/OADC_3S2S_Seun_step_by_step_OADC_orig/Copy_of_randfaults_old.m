function [xv,yv,zv,vec_plane, L, W] = Copy_of_randfaults(xs_now,ys_now,zs_now)
...
%     end
    ...
    hold on; %plot3(xb,yb,zb,'ro')
    
    L = sqrt((xv(1)-xv(2))^2 + (yv(1)-yv(2))^2 + (yv(1)-yv(2))^2);
    W = sqrt((xv(2)-xv(3))^2 + (yv(2)-yv(3))^2 + (yv(2)-yv(3))^2);
    %co(3) = sqrt((xv(3)-xv(4))^2 + (yv(3)-yv(4))^2 + (yv(3)-yv(4))^2);
    %co(4) = sqrt((xv(4)-xv(1))^2 + (yv(4)-yv(1))^2 + (yv(4)-yv(1))^2);
