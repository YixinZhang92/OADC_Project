...
% Last Modified by GUIDE v2.5 06-Sep-2015 17:52:27
...
function azimth_slider_Callback(hObject, eventdata, handles)
% hObject    handle to azimth_slider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
function azimth_slider_CreateFcn(hObject, eventdata, handles)
% hObject    handle to azimth_slider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
