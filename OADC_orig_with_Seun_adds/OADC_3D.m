function OADC_3D(kmin,kmax,err_av,N_loop,infile,simul_tag)
...
% 1. Shuffle random seed generator at the start of the code.
% 2. Number of times OADC_3D splits the thichest faults
% 3. Simulation tag to copy all genrated files and figures to a folder.
% Delete folder with the same simulation tag.i.e., previous runs with the
% same tag.
